...
var DatabaseService = /** @class */ (function () {
    ...
    DatabaseService.prototype.addItem = function (connection, item) {
        return __awaiter(this, void 0, void 0, function () {
            var itemRepo, item_result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        itemRepo = connection.getRepository(item_schema_1.Item);
                        return [4 /*yield*/, itemRepo.create(item)];
                    case 1:
                        item_result = _a.sent();
                        return [4 /*yield*/, itemRepo.save(item_result)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.getItems(connection)];
                }
            });
        });
    };
    DatabaseService.prototype.deleteItem = function (connection, item) {
        return __awaiter(this, void 0, void 0, function () {
            var itemRepo, item_result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        item_result = _a.sent();
                        return [4 /*yield*/, itemRepo.remove(item_result)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.getItems(connection)];
                }
